...
for i = 1:how_many_tasks
    ...
    fig=figure;
    %aviobj = VideoWriter(['C:\MasterinCTH\TME180Project\Signal procressing and data analysis\E-bike and conventional bike analysis\convbike with lidar figure\Di\' datestr(now,30) '.avi']);
    %open(aviobj);
