...
save('intermediate_datatable_backup.mat','TimeStamp_lidar','cartersian_coordinate','cartersian_coordinate_interested','SignalTable_adc','SignalTable_imu','SignalTable_ADCIMU_synchronized','SignalTable_after_preprocessing');
