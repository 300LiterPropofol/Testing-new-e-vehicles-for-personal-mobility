...
save('intermediate_datatable_backup.mat','TimeStamp_lidar','cartersian_coordinate','cartersian_coordinate_interested','SignalTable_imu','SignalTable_after_preprocessing');
