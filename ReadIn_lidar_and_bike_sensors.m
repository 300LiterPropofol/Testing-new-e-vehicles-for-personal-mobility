...
left_threshold = -28; % borderline for x!!!!!!!!!!! modeified later
right_threshold = 37; % borderline for x!!!!!!!!!!! modeified later
for i=1:frame_number_lidar
...
%%
%in the following we are going to process the data, this part
...
SignalTable_after_preprocessing=table(TimeStamp_imu,LinearAcceleration_x_filtered,LinearAcceleration_y_filtered,LinearAcceleration_z_filtered,AngularVelocity_x_filtered,AngularVelocity_y_filtered,AngularVelocity_z_filtered);
