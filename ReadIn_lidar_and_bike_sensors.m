...
up_threshold = 6; % borderline for y!!!!!!!!!!! modeified later
down_threshold = 0; % borderline for y
left_threshold = -26; % borderline for x
right_threshold = 35; % borderline for x
for i=1:frame_number_lidar
...
k_sp= 1;% slope in speed calibration
b_sp= 0;% intercept in speed calibration
